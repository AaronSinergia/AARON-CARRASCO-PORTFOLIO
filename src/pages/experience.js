...
// EXPERIENCE TITLE
const bodyExperienceTitle = () => {
  const experienceContainer = document.querySelector('#container');
  const h1 = document.createElement('h1');
  experienceContainer.className = 'title_name';
  experienceContainer.innerHTML = '.../Experiencia';
  experienceContainer.appendChild(h1);
};
